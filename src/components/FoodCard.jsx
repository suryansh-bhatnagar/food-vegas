...
const FoodCard = ({data}) => {
  ...
  return (
    <div className='py-8 flex justify-between  border-b border-gray-300'>
        ...
        <div className="absolute top-14  bg-white text-center text-sm font-medium text-green-600  m-2 w-20 p-1 shadow-lg rounded-md" onClick={()=>dispatch(addToCart(data.card.info))}>
                    ADD  
                </div>
        </div>
